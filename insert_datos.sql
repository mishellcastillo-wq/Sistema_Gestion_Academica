...
-- TABLA: Matricula
-- ============================================================
INSERT INTO Matricula (codigo_Matricula, cedula_Estudiante, codigo_Materia) VALUES
  (1, '0485964547', 'COC601'),   -- Milena Samanta    → Cocina Internacional
  (2, '1100451213', 'TEJ402'),   -- Pauleth Monserrath → Diseno de Prendas
  (3, '1150528899', 'BOX201'),   -- Mishell Vanessa   → Tecnicas de Golpeo
  (4, '1184597457', 'COC602'),   -- Marco David       → Cocina Saludable
  (5, '2645256895', 'BOX202');   -- Jhon Alejandro    → Defensa y Resistencia
 
 
-- ============================================================
-- TABLA: Calificacion
-- ============================================================
INSERT INTO Calificacion (identificador, nota_final, estado, codigo_Matricula) VALUES
  (1, 8.00, 'Aprobado',   3),   -- Mishell Vanessa    / Tecnicas de Golpeo
  (2, 5.00, 'Supletorio', 5),   -- Jhon Alejandro     / Defensa y Resistencia
  (3, 7.00, 'Aprobado',   1),   -- Milena Samanta     / Cocina Internacional
  (4, 9.80, 'Aprobado',   2),   -- Pauleth Monserrath / Diseno de Prendas
  (5, 6.95, 'Supletorio', 4);   -- Marco David        / Cocina Saludable
...
-- ============================================================
INSERT INTO Supletorio (identificador, nota_examen_supletorio, nota_final, resultado, identificador_Calificacion) VALUES
  (1, 9.00, 7.00, 'Aprobado',  2),   -- Jhon Alejandro:  (5.00 + 9.00) / 2 = 7.00 → Aprobado
  (2, 7.00, 6.98, 'Reprobado', 5);   -- Marco David:     (6.95 + 7.00) / 2 = 6.98 → Reprobado